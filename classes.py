...
class GerenciadorPlanilha:
    ...
    def adiciona_grafico_linha(self, celula: str, comprimento: float, altura: float, titulo: str, titulo_eixo_x: str,
                               titulo_eixo_y: str, referencia_eixo_x: Reference, referencia_eixo_y: Reference,
